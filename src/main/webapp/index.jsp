...
<body>
	...
	<h1 style="color: pink; font-size: 40px;" align="center">This is a for test</h1>
	<h1 style="color: red; font-size: 40px;" align="center">WE INTEGRATED NEXUS TO JENKINS</h1>
        <h2 style="color: purple; font-size: 40px;" align="center">Deployed my first app in tomcat</h2>
